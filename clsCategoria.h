...
//LA CLASE CATEGORIA NO TIENE EL CAMPO ESTADO PORQUE NO SE PUEDE DAR DE BAJA LA CATEGORIA ASIGNADA A UN
//REGISTRO, DE ESTA FORMA SE MANTIENE LA INTEGRIDAD DE LOS MOVIMIENTOS CARGADOS.
class Categoria{
    private:
